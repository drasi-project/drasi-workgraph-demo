...
is non-empty, comment-ready Markdown that accurately reflects the Result and
contains no fenced code block. The runtime publishes that exact candidate to
the ordinary Root Issue only after acceptance.
